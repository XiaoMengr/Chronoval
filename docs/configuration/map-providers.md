...
Chronoval supports two types of map providers. You can choose the one that best fits your needs.
...
```bash
# Chronoval comes with built-in light and dark styles that switch automatically.
