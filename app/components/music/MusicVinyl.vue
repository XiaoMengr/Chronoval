...
<template>
  ...
  >
    ...
    <!-- 静止高光层：不随唱片旋转，模拟黑胶表面的光泽 -->
    <div
      class="pointer-events-none absolute inset-0 rounded-full"
      style="
        background: radial-gradient(circle at 32% 24%, rgba(255,255,255,0.14) 0%, rgba(255,255,255,0.05) 16%, transparent 40%),
                    linear-gradient(115deg, rgba(255,255,255,0.09) 0%, transparent 30%, transparent 65%, rgba(255,255,255,0.04) 100%);
      "
    />
  </div>
</template>
